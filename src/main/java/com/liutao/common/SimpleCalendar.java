    ...
    public static  class Element{
		...
		public String toString() {
			return "Element [sYear=" + sYear + ", sMonth=" + sMonth + ", sDay=" + sDay + ", week=" + week + ", lYear="
					+ lYear + ", lMonth=" + lMonth + ", lMonthChinese=" + lMonthChinese + ", lDayChinese=" + lDayChinese
					+ ", lDay=" + lDay + ", isLeap=" + isLeap + ", cYear=" + cYear + ", cMonth=" + cMonth + ", cDay="
					+ cDay + ", color=" + color + ", isToday=" + isToday + ", lunarFestival=" + lunarFestival
					+ ", solarFestival=" + solarFestival + ", solarTerms=" + solarTerms + ", sgz5=" + sgz5 + ", sgz3="
					+ sgz3 + "]";
		}
